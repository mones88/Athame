...
namespace AthameWPF.UI.Windows
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private SettingsPage SettingsPage { get; } = new SettingsPage();
        private QueuePage QueuePage { get; } = new QueuePage();
        private SearchPage SearchPage { get; } = new SearchPage();
        ...
        private PathToggleButton selectedMainRadioButton;
